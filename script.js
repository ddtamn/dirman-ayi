...
guestName.addEventListener("input", (e) => {
  invitationURI.value =
    "https://dinvite.ajakan.me/dirman-ayi?to=" + convertToSlug(e.target.value);
  ...
  shareButton.href = `https://api.whatsapp.com/send/?text=https://dinvite.ajakan.me/dirman-ayi?to=${convertToSlug(
    e.target.value
  )}`;
});
copyButton.addEventListener("click", function () {
  if (targetValue) {
    navigator.clipboard.writeText(
      `https://dirman-ayi.vercel.app/da/?to=${convertToSlug(targetValue)}`
    );
